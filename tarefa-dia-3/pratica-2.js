...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 'if' ('a' é iguak a 10)
if (a == 10) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 'else' ('a' não maior que 10 )
if (a > 10) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 'if' ( 10 é igual a 'a') 
if (10 <= a) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 'if' (b é true)
if (b == true) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 'if' (b equivalide a verdadeiro)
if (b) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 'if' ('c' possui valor )
if (c) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 'if' ('d' possui valor)
if (d) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 'if' ( o valor da primeira posiçao é 1)
if (d[0] == 1) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 'else'( o valor da segunda posiçao é 2)
if (d[1] == 1) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 'if'('nome' é uma string)
if (typeof(e) == 'string') {
